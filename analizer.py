...
#file_magic = magic.Magic(magic_file=r"C:\Users\max\Desktop\pija-master\magic.mgc")
...
def get_type(path):
    ...
    typedoc=None
    if file_extension=='.bmp' or  file_extension=='.dib' or file_extension=='.jpeg' or  file_extension=='.jpg' or  file_extension=='.jpe' or file_extension=='.jp2' or  file_extension=='.png' or  file_extension=='.webp' or  file_extension=='.pbm' or  file_extension=='.pgm' or  file_extension=='.ppm' or file_extension=='.sr' or  file_extension=='.ras' or  file_extension=='.tiff' or  file_extension=='.tif':
        typedoc = "image"
    if file_extension=='.mp4' or file_extension=='.m4v' or file_extension=='.mkv' or file_extension=='.webm' or file_extension=='.mov' or file_extension=='.avi' or file_extension=='.wmv' or file_extension=='.mpg' or file_extension=='.flv':
        typedoc =None # "video"
